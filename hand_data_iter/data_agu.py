...
def hand_alignment_aug_fun(imgn, eye_left_n, eye_right_n, facial_landmarks_n=None, angle=None, desiredLeftEye=(0.34, 0.42), desiredFaceWidth=160, desiredFaceHeight=None,
                           draw_flag=False):
    ...
    output = cv2.warpAffine(imgn, M, (w, h), flags=cv2.INTER_LINEAR,
                            borderMode=cv2.BORDER_CONSTANT)  # INTER_LINEAR INTER_CUBIC INTER_NEAREST
